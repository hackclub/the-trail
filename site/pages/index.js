...
<meta property="og:image:height" content="https://cloud-hqqequftm-hack-club-bot.vercel.app/0coolimage__1_.png" />
      ...
      <main style={{maxWidth: "100vw", overflow: "hidden", backgroundColor: "#FFF5D8", height: "100%"}}>
...
<Box sx={{display: "flex", alignItems: "center", width: '100vw', justifyContent:"center"}}>
  ...
  width: 86, height: 86, right: 16, zIndex: 2, top:164, cursor: rotation < 360 ? ("wait") : ("auto")}} src="beginnersWelcome.svg"/>

    <p></p>
    <Box sx={{objectFit: "fit", overflow: "hidden", width: "100%", position: "relative"}}>

    <Image sx={{display: ["none", "flex", "flex"], objectFit: "fit", overflow: "hidden", width: "100%", userDrag: "none", WebkitUserDrag: "none"}} src={rotation < 360 ? ("./rightHalf.svg") : ("./HikeIRL.png")}/>
        ...
        <Box sx={{display: "flex", fontSize: 24, lineHeight: 1.5, padding: [24, 24, 32], flexDirection: 'column',}}>
          <p>
          Build a piece of electronic trail equipment (e.g. Flash Lights, Stoves, GPS Compasses, Radios, Head Lamps, Trail Game Consoles, NFC Trail Board Games, Vintage Trail Cameras, etc) with your friends to make this adventure possible.
          </p>
        ...
        <Box sx={{flexDirection: ["column", "row", "row"], display: "flex", fontSize: 24, lineHeight: 1.5, padding: 0, justifyContent: "space-between"}}>
          ...
          <Box sx={{display: "flex", flexDirection: "column"}}>
            <p style={{fontSize:20}}>Sign up and then open a PR with your piece of trail equipment idea to our <a style={{color: "#032412"}} href="https://github.com/hackclub/trail">Trail GitHub Repo</a>.</p>
          ...
          <Box sx={{display: "flex", flexDirection: "column"}}>
            ...
            Now, time to create and order PCB. This will be a bit nerve-racking but you'll get a full design review and be able to confidently order the board. You'll also get the opportunity to add a wild silk screen.
          ...
          <Box sx={{display: "flex", flexDirection: "column"}}>
            ...
            Now you can be creative and make some sort of case for your circuit to cover up that fiberglass. We recommend 3D printing a case, but you're also welcome to experiment with making a case out of metal or wood.
      ...
      Deadline To Sign Up: {timeLeft.days} days {timeLeft.hours} hours {timeLeft.minutes} minutes {timeLeft.seconds} seconds
          ...
          <Box sx={{marginTop: 32, display: "flex", flexDirection: ["column", "row", "row"]}}>
            ...
            <Box style={{borderBottom: "4px solid #032412", paddingBottom: 16}}>
  ...
  we traveling on?</p>
            ...
            <Box sx={{borderBottom: "4px solid #032412", paddingBottom: 16, marginTop: 16}}>
